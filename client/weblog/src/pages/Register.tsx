                        ...
                        <>
                            ...
                            <div className='flex flex-col justify-around gap-5 border shadow-md w-max h-max p-4'>
                                ...
                                <div className='text-center'>
                                    <button className='bg-indigo-600 w-[35vw] shadow-md rounded-sm p-2 text-md font-semibold text-white' onClick={() => { userreginfo?.handleSubmit; setLoader(!loader) }}>Register</button>
                                </div>
                            </div>
                        </>
                    )
