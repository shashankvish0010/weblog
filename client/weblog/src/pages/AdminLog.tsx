                ...
                <div>
                    <form method='POST' className='flex gap-3 flex-col justify-center'>
                        <span className='flex flex-col gap-1'>
                            ...
                            <input className='px-2 h-[2.25rem] w-[65vw] md:w-[35vw] border rounded' type="text" name='email' value={Admindata?.admin.email.toString()} onChange={Admindata?.handleChange} />
                        </span>
                        <span className='flex flex-col gap-1'>
                            <p className='text-sm text-gray-600'>Password</p>
                            <input className='px-2 h-[2.25rem] w-[65vw] md:w-[35vw] border rounded' type="password" name='admin_password' value={Admindata?.admin.admin_password.toString()} onChange={Admindata?.handleChange} />
                        </span>
                    </form>
                </div>
